...
function IndexApp() {
  const data = [
    ...
    },
    {
      ...
      introduce: '這是一個線上學習網站，主要提供使用者線上學習手藝，專案由 AAPD 學員提供設計，並由我們的團隊進行前端開發，我負責首頁、我的課程頁面、探索課程頁面，同時擔任組長',
        ...
        <section className="row ">
          ...
          <div className="col-lg-8 bg-white px-4  pt-5">
            ...
            <div className="mb-4">
              <div className="d-flex ">
                <div className="d-flex align-items-center">
                  <svg className="me-2" xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#000000"><path d="M280-280h280v-80H280v80Zm0-160h400v-80H280v80Zm0-160h400v-80H280v80Zm-80 480q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm0-560v560-560Z" /></svg>
