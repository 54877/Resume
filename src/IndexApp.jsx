...
function IndexApp() {
  ...
  const data = [
    ...
    },
    {
      ...
      title: `購物前後台-簡易功能`,
      introduce:
        "這是一個擁有簡易功能的購物前後台網站，主要提供使用者新增商品，並且可在後台控制商品細項調整，專案由六角提供設計稿",
      skill: `使用到了javascript，這專案加強了我 javascript 技能與獨立作業能力`,
    },
    {
      ...
      title: `套票與選單-簡易功能`,
      introduce:
        "這是一個擁有簡易功能的套票網站，主要提供使用者新增套票與查詢，專案由六角提供設計稿",
      skill: `使用到了 javascript ，這專案加強了我 javascript 技能與獨立作業能力`,
    },
    {
      ...
      title: `前後台功能-簡易功能`,
      introduce:
        "這是一個擁有前後台商品管理的網站，主要提供使用者新增購物清單與後台新增刪除商品，專案由六角提供設計稿",
      skill: `使用到了 React+vite ，這專案加強了我 React+vite 框架技能與獨立作業能力`,
    },
    {
      ...
      introduce:
        "這是一個線上學習網站，主要提供使用者線上學習手藝，專案由 AAPD 學員提供設計，並由我們的團隊進行前端開發，我負責首頁、我的課程頁面、探索課程頁面，同時擔任組長",
      skill: `使用到了 HTML、CSS ，這專案不僅加強了我前端開發技能，還提升了團隊協作中的溝通與領導能力`,
    },
    {
      ...
      title: `Vivre-旅遊網站`,
      introduce:
        "這是一個旅遊網站，主要提供使用者線上查看旅遊方案，專案由六角提供設計稿",
      skill: `使用到了 HTML、CSS ，這專案加強了我前端開發技能與獨立作業能力`,
    },
    {
      ...
      introduce:
        "這是一個線上學習課程網站，主要提供使用者線上學習，專案由六角提供設計稿",
      skill: `使用到了 HTML、CSS ，這專案加強了我前端開發技能與獨立作業能力`,
    },
    {
      ...
      title: `眼鏡官網`,
      introduce:
        "這是一個眼鏡官網，主要提供使用者線上查看眼鏡，專案由六角提供設計稿",
      skill: `使用到了 HTML、CSS ，這專案加強了我前端開發技能與獨立作業能力`,
    },
    {
        ...
        <section className="row ">
          <div className="col-lg-4 bg-black ">
            <div className="sticky-top d-flex flex-column align-items-center pt-5">
              ...
              <div
                style={{ paddingTop: 60 }}
                className="d-flex pb-4 justify-content-center align-items-center border-4 border-top border-white w-100"
              >
                <svg
                  className="me-2"
            ...
            <div className="mb-4">
              <div className="d-flex">
                <div className="d-flex align-items-center">
                  ...
                  <h2 className="m-lg-0 mt-2 fw-bold">MY PROFILE</h2>
                </div>
                ...
                <div className="ms-4">
                  <ul>
                    <li className="fs-6 mb-3">
                      過去在零售、餐飲服務及設備維護的經歷，讓我練就高壓下的高效執行力、細膩的跨部門溝通，以及嚴謹的細節管理能力。
                    </li>
                    <li className="fs-6 mb-3">
            ...
            <div className="mb-4">
              <div className="d-flex">
                <div className="d-flex align-items-center">
                  ...
                  <h2 className="m-lg-0 mt-2 fw-bold">WORK EXPERIENCE</h2>
                </div>
                <div className="d-lg-block d-none ms-3 me-4 flex-grow-1 border-tr border-4 border-bottom border-dark"></div>
              </div>
              <div className="px-4">
                ...
                <div className="ms-4">
                  ...
                  <div className="d-lg-flex d-none justify-content-between mb-3">
                    <span>半導體設備工程師</span>
                    <span className="text-secondary">2021/6 ~2024/6</span>
                  </div>
                ...
                <div className="ms-4">
                  ...
                  <div className="d-lg-flex d-none justify-content-between mb-3">
                    <span>前端工程師</span>
                    <span className="text-secondary">2025/8 ~ 至今</span>
                  </div>
                  <p className="d-lg-none">前端工程師</p>
                  <p className="text-secondary d-lg-none">2025/8 ~ 至今</p>
                </div>
              </div>
            </div>
            {/* 學歷 */}
            <div className="mb-4">
              <div className="d-flex">
                <div className="d-flex align-items-center">
                  ...
                  <h2 className="m-lg-0 mt-2 fw-bold">EDUCATION</h2>
                </div>
                <div className="d-lg-block d-none  ms-3 me-4 flex-grow-1 border-tr border-4 border-bottom border-dark"></div>
              </div>
              <div className="px-4">
                ...
                <div className="ms-4 mb-4">
                  ...
                  <div className="d-lg-flex d-none justify-content-between mb-3">
                    <span>畢業 ｜國內</span>
                    <span className="text-secondary">2016/9 ~2020/9</span>
                  </div>
                  <p className="d-lg-none">大學 ｜畢業 ｜國內</p>
                  <p className="text-secondary d-lg-none">2016/9 ~2020/9</p>
                ...
                <div className="ms-4">
                  ...
                  <div className="d-lg-flex d-none justify-content-between mb-3">
                    <span>網頁切版直播班</span>
                    <span className="text-secondary">2024/7 ~2024/10</span>
                  </div>
                  <p className="d-lg-none">網頁切版直播班</p>
                  <p className=" fs-7">
                    — 學習 Html 、 Css 、 RWD 、 GitHub 、 Bootstrap 5
                  </p>

                  <p className="text-secondary d-lg-none fs-7">
                    2024/7 ~2024/10
                  </p>
                  <div className="d-lg-flex d-none justify-content-between mb-3">
                    <span>JavaScript 工程師養成直播班</span>
                    <span className="text-secondary">2024/10 ~2024/12</span>
                  </div>
                  ...
                  <div className="d-lg-flex d-none justify-content-between mb-3">
                    <span>React作品實戰</span>
                    <span className="text-secondary">2025/1 ~2025/4</span>
                  </div>
                  <p className="d-lg-none">React作品實戰</p>
                  <p className=" fs-7">— 學習 React 框架</p>
                  <p className="d-lg-none text-secondary">2025/1 ~2025/4</p>
                </div>
              </div>
            </div>
            {/* SKILLS */}
            <div className="mb-4">
              <div className="d-flex">
                <div className="d-flex align-items-center">
                  ...
                  <h2 className="m-lg-0 mt-2 fw-bold">SKILLS</h2>
                </div>
                <div className="d-lg-block d-none ms-3 me-4 flex-grow-1 border-tr border-4 border-bottom border-dark"></div>
              </div>
              <div className="px-4">
                ...
                <div className="ms-4  flex-wrap d-flex ">
                  <div className="d-flex align-items-center w-p  mb-3  ">
                    ...
                    <span className="fs-7 fw-bold">HTML</span>
                  </div>
                  <div className="d-flex align-items-center w-p mb-3  ">
                    <svg
                      className="me-3"
                    ...
                    <span className="fs-7 fw-bold">CSS , SCSS</span>
                  </div>
                  <div className="d-flex align-items-center w-p mb-3  ">
                    <svg
                      className="me-3"
                    ...
                    <span className="fs-7 fw-bold">JS / TS</span>
                  </div>
                  <div className="d-flex align-items-center w-p mb-3 ">
                    <svg
                      className="me-3"
                    ...
                    <span className="fs-7 fw-bold">REACT</span>
                  </div>
                  <div className="d-flex align-items-center w-p mb-3 ">
                    <svg
                      className="me-3"
                    ...
                    <span className="fs-7 fw-bold">Axios</span>
                  </div>
                  <div className="d-flex align-items-center w-p mb-3">
                    <svg
                      className="me-3"
                    ...
                    <span className="fs-7 fw-bold">Bootstrap 5</span>
                  </div>
                  <div className="d-flex align-items-center w-p  mb-3">
                    <svg
                      className="me-3"
                    ...
                    <span className="fs-7 fw-bold">RWD</span>
                  </div>
                  <div className="d-flex  align-items-center w-p mb-3">
                    <svg
                      className="me-3"
                  ...
                  <div className="d-flex  align-items-center w-p mb-3">
                    ...
                    <span className="fs-7 fw-bold"> styled-components</span>
                  </div>
                  <div className="d-flex  align-items-center w-p mb-3">
                    <svg
                      className="me-3"
                  ...
                  <div className="d-flex  align-items-center w-p mb-3">
                    ...
                    <span className="fs-7 fw-bold">postman</span>
                  </div>
                </div>
              </div>
            </div>
